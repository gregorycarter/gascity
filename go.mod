...
require (
	...
	github.com/steveyegge/beads v1.2.2-0.20260820081939-6c35a31db1ea
...
// while sourcing the exact commit from the city operator's fork.
replace github.com/steveyegge/beads => github.com/gregorycarter/beads v1.2.2-0.20260820081939-6c35a31db1ea
